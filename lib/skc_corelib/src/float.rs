    ...
    vec![
        create_comparison_method!(
            ...
            fn f<'a>(
                ...
                code_gen
                    .builder
                    .build_float_compare(inkwell::FloatPredicate::OEQ, val1, val2, "eq")
            }
        ),
        create_comparison_method!(
            "!=",
            fn f<'a>(
                ...
                code_gen.builder.build_float_compare(
        ...
        create_comparison_method!(
            ...
            fn f<'a>(
                ...
                code_gen
                    .builder
                    .build_float_compare(inkwell::FloatPredicate::OLT, val1, val2, "lt")
            }
        ),
        create_comparison_method!(
            ">",
            fn f<'a>(
                ...
                code_gen
                    .builder
                    .build_float_compare(inkwell::FloatPredicate::OGT, val1, val2, "gt")
            }
        ),
        create_comparison_method!(
            "<=",
