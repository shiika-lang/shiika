...
//            }
    ...
    pub (in super) fn llvm_func_type(&self, self_ty: &TermTy, signature: &MethodSignature) -> inkwell::types::FunctionType {
    ...
    pub (in super) fn llvm_type(&self, ty: &TermTy) -> inkwell::types::BasicTypeEnum {
        match ty.body {
            TyBody::TyRaw => {
