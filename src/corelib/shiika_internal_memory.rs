...
pub fn create_class_methods() -> Vec<SkMethod> {
    ...
    create_method("Meta:Shiika::Internal::Memory", "gc_malloc(n_bytes: Int) -> Shiika::Internal::Ptr", |code_gen, function| {
        let n_bytes = function.get_params()[1].into_int_value();
        ...
        let mem = code_gen.builder.build_call(func, &[n_bytes_64.into()], "mem").try_as_basic_value().left().unwrap();
        code_gen.builder.build_return(Some(&mem));
        Ok(())
    }),

    create_method("Meta:Shiika::Internal::Memory", "gc_realloc(ptr: Shiika::Internal::Ptr, n_bytes: Int) -> Shiika::Internal::Ptr", |code_gen, function| {
...
//
//
    create_method("Meta:Shiika::Internal::Memory", "memcpy(dst: Shiika::Internal::Ptr, src: Shiika::Internal::Ptr, n_bytes: Int) -> Void", |code_gen, function| {
